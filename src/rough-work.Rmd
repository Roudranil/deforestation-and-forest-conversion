...
4. maximum forest conversion by year
```{r}
forest %>% 
    group_by(year) %>% 
...
forest_area %>% 
    ...
    labs(title = "Top 10 countries with maximum change in forest area between 1993 and 2020",
         x = "Countries",
...
brazil_loss %>%
    ...
    guides(color = "none") +
    labs(title = "Causes which result in the highest loss of forest in Brazil by year apart from pastures",
         fill = "Cause of loss",
         x = "Year",
